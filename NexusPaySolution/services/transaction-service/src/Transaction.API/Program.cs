...
using Transaction.Infrastructure.MessageBus.Options;
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "Transaction Service - NexusPay",
        Version = "v1",
        Description = "Microservice for transactions NexusPay",
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(options =>
    {
        ...
        options.DocumentTitle = "NexusPay Transaction Service";
...
while (retry < 5)
{
    try
    {
        ...
        await consumer.Subscribe<TransactionDeniedEvent>("wallet.transaction.denied", "transaction-denied-queue");
        await consumer.Subscribe<TransactionCompletedEvent>("wallet.transaction.completed", "transaction-completed-queue");
